...
override LDFLAGS += -X "github.com/AdrienEti/yip/cmd.BuildTime=$(shell date -u '+%Y-%m-%d %I:%M:%S %Z')"
override LDFLAGS += -X "github.com/AdrienEti/yip/cmd.BuildCommit=$(shell git rev-parse HEAD)"
